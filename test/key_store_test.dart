...
int main() {
  test('JWK', () {
    testJwk(RsaPublicKey(
        ...
        exponent: BigInt.parse("198347593284574598678235692836579185693487523"),
      ), RsaPrivateKey(
        privateExponent: BigInt.parse("63498570293485908425760982730598034986"),
        firstPrimeFactor: BigInt.parse("7237589720986702937598457698479823745"),
        secondPrimeFactor: BigInt.parse("398735098203983587687298375018104938"),
        modulus: BigInt.parse("9283450293849383948573984759872394873945874958"),
    ...
    testJwk(RsaPublicKey(
        modulus: BigInt.parse("4938759348709837456098928374987540968309283400"),
        exponent: BigInt.parse("294857049568309873458098174059801364571329429"),
      ), null, '{"kty":"RSA","alg":"RS256","use":"sig",' +
